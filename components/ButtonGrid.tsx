...
export function ButtonGrid() {
  ...
  const handleCopyColab = () => {
    const colabLink = 'https://colab.research.google.com/drive/1HktoOa1RSQrpF1TwVRZBQ64TM7QyV5jR?usp=sharing';
    navigator.clipboard.writeText(colabLink).then(() => {
      setCopiedColab(true);
  ...
  return (
    <div className="flex flex-col gap-4 p-4 items-center">
      <Button
        ...
        className={copiedColab ? "bg-green-500 hover:bg-green-600" : ""}
      >
        {copiedColab ? "Copied!" : "Google Colab Link"}
      </Button>
